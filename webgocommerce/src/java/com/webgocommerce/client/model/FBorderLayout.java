 ...
 * @author SISTEMAS
 */
public class FBorderLayout extends Composite{
    ...
    private void initStyle(){
        ...
        MyResource.INSTANCE.getStlFBorderLayout().ensureInjected();        
    }
