 ...
 * @author SISTEMAS
 */
public class UIMantCoordinador extends UIMantenimiento implements InterUIMantCoordinador, KeyUpHandler, ChangeHandler, BlurHandler{
    ...
    protected CoordinadorProxy bean;

    public UIMantCoordinador() {
        initComponents();
        initListener();
        initStyle();
        reCalcularWindows();
    ...
    public void setBean(CoordinadorProxy bean) {
        this.bean = bean;
    }
