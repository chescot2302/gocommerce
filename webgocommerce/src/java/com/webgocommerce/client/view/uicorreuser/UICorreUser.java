...
import com.webgocommerce.client.view.grid.GridUsuarioCorrelativo;

/**
 *
 * @author SISTEMAS
 */
public class UICorreUser extends UIFormMantenimiento implements KeyUpHandler, InterUICorreUser{
