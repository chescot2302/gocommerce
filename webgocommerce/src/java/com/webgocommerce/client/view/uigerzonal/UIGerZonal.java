...
import com.webgocommerce.client.view.grid.GridGerenteZonal;
 ...
 * @author SISTEMAS
 */
public class UIGerZonal extends UIFormMantenimiento implements InterUIGerZonal,KeyUpHandler{
    private MSearchBox txtBuscar;
    protected GridGerenteZonal grid;
    ...
    @Override
    public void processDesactivar(GerenteZonalProxy bean, Date fechaIncorporacion) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
