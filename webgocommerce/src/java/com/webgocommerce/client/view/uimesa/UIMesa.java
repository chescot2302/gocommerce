...
import com.webgocommerce.client.view.grid.GridMesa;

/**
 *
 * @author SISTEMAS
 */
public class UIMesa extends UIFormMantenimiento implements InterUIMesa,KeyUpHandler/*,ChangeHandler*/{
    private MSearchBox txtBuscar;
    protected GridMesa grid;
    private Button btnDesactivar;
    private Button btnEditConsultor;
    ...
    private void initComponents(){ 
        ...
        btnEditConsultor=new Button("Consultores");
        ...
        this.addComponent(btnEditConsultor);
    ...
    private void initListener(){
        ...
        btnEditConsultor.addClickHandler(clickHandler);
    }
    ...
    ClickHandler clickHandler=new ClickHandler(){
        ...
        public void onClick(ClickEvent event) {
            if(event.getSource().equals(btnDesactivar)){
                showUIDesactivar();
            }else if(event.getSource().equals(btnEditConsultor)){
                showUIEditConsultor();
