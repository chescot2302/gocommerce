...
import com.webgocommerce.client.view.grid.GridClienteCall;
import com.webgocommerce.client.view.uilocalidad.InterUILocalidad;

/**
 *
 * @author SISTEMAS
 */
public class UIClienteCall extends UIFormMantenimiento implements InterUIClienteCall,KeyUpHandler/*,ChangeHandler*/{
    private MSearchBox txtBuscar;
    protected GridClienteCall grid;
    protected Button btnExportar;
    
    public UIClienteCall(){
        initComponents();
        initListener();
        initStyle();
        reCalcularWindows();
