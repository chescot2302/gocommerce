 ...
 * @author SISTEMAS
 */
public class UIMantLocalidad extends UIMantenimiento implements InterUIMantLocalidad, KeyUpHandler {

    protected TextBox txtId;
    protected TextBox txtDescripcion;
    protected LocalidadProxy bean;
    ...
    public void loadFields() {
        if (this.modo.equals(UIMantenimiento.MODOUPDATE)) {
            txtId.setText(this.bean.getIdLocalidad().toString());
    ...
    public void setBean(LocalidadProxy bean) {
        this.bean = bean;
    }
