...
import com.webgocommerce.client.view.grid.GridSupervisor;
 ...
 * @author SISTEMAS
 */
public class UISupervisor extends UIFormMantenimiento implements InterUISupervisor,KeyUpHandler/*,ChangeHandler*/{
    private MSearchBox txtBuscar;
    protected GridSupervisor grid;
    ...
    @Override
    public void processDesactivar(SupervisorProxy bean, Date fechaIncorporacion) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
