 ...
 * @author SISTEMAS
 */
public class UIDocVentaImpl extends UIDocVenta{
    private DateTimeFormat dateFormat = DateTimeFormat.getFormat("dd/MM/yyyy");
    PopupProgress popup = new PopupProgress();
    private final FactoryGestion FACTORY = GWT.create(FactoryGestion.class);
    private final EventBus EVENTBUS = new SimpleEventBus();
    private UIHomeDocVenta uiHomeDocVenta;


    public UIDocVentaImpl(UIHomeDocVenta uiHomeDocVenta) {
    ...
    public void gridUpdate(){
        grid.removeColumn(grid.estadoAct);
        grid.removeColumn(grid.codProy);
        grid.removeColumn(grid.totalPlan);  
        grid2.removeColumn(grid2.equipos);
    }
    ...
    public void loadSeriesUserVenta() {
        ...
        Request<List<CorrelativoProxy>> request = context.getSerieUserVenta(keyPublic, UISesion.beanUsuario.getId(), UISesion.beanUsuario.getIdPuntoEmision());
    ...
    public void loadTable() {        
        ...
        Request<List<CabeceraVentaProxy>> request = context.listarVentas(keyPublic, boxDateIni.getValue(), boxDateFin.getValue(), rucCliente, descCliente, docSeries, correlativo, chkSoloAnulados.getValue()?"A":"S", chkExcluirFechas.getValue()?"S":"N");
    ...
    public void showUIOper4() {
        ...
        if(bean!=null){            
            ...
            FACTORY.initialize(EVENTBUS);
            String keyPublic = UISesion.keyPublic;
            Request<List<DetalleVentaProxy>> request = context.getDetalleVenta(keyPublic,bean.getTipoDoc(),bean.getCorrelativo());
