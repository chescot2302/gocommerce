...
import com.gocommerce.server.model.logic.LogicPuntoEmision;
 ...
 * @author SISTEMAS
 */
public class MantenimientoPuntoEmision {
    public static List<PuntoEmision> listarPtoEmisionxTienda(String clavePublica,String idTienda) throws UnknownException{
        ...
        try{
            ...
            if(!pm.isClosed()){
                LogicPuntoEmision logic = new LogicPuntoEmision(pm);  
                JDOConnection cnxJDO = pm.getDataStoreConnection();
                cnx =(Connection)cnxJDO.getNativeConnection();                
                List<PuntoEmision> lista=logic.getListarBeanxTienda(cnx,idTienda);  
                cnx.close();
                return lista;
            }else{
